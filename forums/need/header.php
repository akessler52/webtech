...
<head lang="en">
 ...
 <body>
    <ul>
        ...
        <li><a href="/webtech/forums/createtopic.php">New topic</a></a></li>
        <li><a href="/webtech/forums/createcat.php">New category</a></li>
        <ul style="float:right">
            <li><a href="/webtech/login.php">Login</a></li>
            <li><a href="/webtech/register.php">Register</a></li>
          </ul>
    </ul>
