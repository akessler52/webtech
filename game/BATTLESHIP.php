...
<body>
 ...
 function showGrid(ispc) {
   ...
   for (y=0;y<gridy;++y) {
     for (x=0;x<gridx;++x) {
       if ( ispc )
       document.write ('<a href="javascript:gridClick('+y+','+x+');"><img name="pc'+y+'_'+x+'" src="BS100.png" width=32 height=32></a>');
       else
       document.write ('<a href="javascript:void(0);"><img name="ply'+y+'_'+x+'" src="BS'+player[y][x][0]+'.png" width=32 height=32></a>');
     }
     document.write('<br>');
   }
 }
